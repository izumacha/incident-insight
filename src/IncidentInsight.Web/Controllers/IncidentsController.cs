...
public class IncidentsController : Controller
{
    ...
    private async Task<CauseCategoryFilterSelection> ResolveCauseCategoryFilterAsync(int? causeCategoryId)
    {
        ...
        var parents = await _db.CauseCategories
            ...
            // 一覧のページングや DepartmentFilterResolver が Id を足しているのと同じ理由
            .ThenBy(c => c.Id)
    ...
    /// 意味と各要素の役割は <see cref="Internal.DepartmentFilterResolver.DepartmentFilterSelection"/> と同じ
    ...
    /// 解除されるだけだった <see cref="Internal.DepartmentFilterResolver.ResolveAsync"/> と違い、
    ...
    /// ——<see cref="Internal.DepartmentFilterResolver.ResolveAsync"/> が値と選択肢を組で返すのと同じ構図。</para>
    ///
    ...
    /// </summary>
    /// <remarks>
    /// 2 つを 1 つの型にまとめてある理由は <see cref="Internal.DepartmentFilterResolver.DepartmentFilterSelection"/> と同じ
