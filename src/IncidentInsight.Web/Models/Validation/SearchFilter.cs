...
/// <c>/AuditLogs</c> のエンティティ名・操作種別に注意書きが無いのは、いまも
/// <b>その画面がその入力について「黙って落とす」を選んでいる</b>からで
/// (上の「黙って落とさない」の段落がその理由を持つ)、注意書きの仕組みが無いからではない
/// ——あの画面は読めない期間指定については注意書きを出す(issue #207)。</para>
///
